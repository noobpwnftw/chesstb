...
private:
	...
	Table_Reader_Map<DTM_Final_Entry> m_sub_dtm_by_material;
	Table_Reader_Map<DTM_Final_Entry> m_exit_dtm_by_material;
	Table_Reader<DTM_Final_Entry>* m_exit_reader[COLOR_NB][Castling_Group::MAX_RIGHTS + 1]{};
	...
	NODISCARD DTM_Final_Entry read_exit_dtm(const Exit_Site& site) const;
	...
	NODISCARD DTM_Final_Entry make_initial_entry(Position_For_Gen& pos_gen,
	...
	void retro_mark_wins(Position_For_Gen& pos_gen, uint16_t target_dtm);
