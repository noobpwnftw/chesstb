...
template std::vector<std::vector<int32_t>> EGTB_Generator::compute_fusion_groups<DTM50_Final_Entry, DTM50_Intermediate_Entry>(const Sliced_EGTB_File_For_Gen<DTM50_Final_Entry, DTM50_Intermediate_Entry>&, const std::vector<int32_t>&, size_t, bool) const;
