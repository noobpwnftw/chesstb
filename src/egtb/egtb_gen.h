...
// Falls back to full re-canonicalization for king moves, pawn moves, and
// self-stabilizer slices (all can shift canonical orientation).
NODISCARD Board_Index next_quiet_index(const Piece_Config_For_Gen& epsi,
