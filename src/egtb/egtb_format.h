...
// pushes. Solve budgets 0..29; budget 30 needs no further pawn push and its
// terminal value is supplied by the embedded DTZ row for clean W/L cells.
// Cursed/blessed cells use row 0 only as DTZ.
inline constexpr size_t DTC_BUDGET_LAYERS = 30;
...
// DTC's 31 layers take 4 bytes, DTM50's 101 take 16. Lives here beside the layer
