...
// markers for a WIN/LOSE whose zeroing move sits exactly at the 50mr edge
...
struct DTZ_Intermediate_Entry : DTZ_Entry_Base
{
	...
	NODISCARD static constexpr DTZ_Intermediate_Entry make_cap_closs() { return DTZ_Intermediate_Entry{DTZ_FLAG_CAP_CLOSS}; }
...
//
// DRAW is WDL-companion authoritative across DTZ/DTM/DTM50: the encoder
...
using DTZ_Any_Entry = std::variant<DTZ_Intermediate_Entry, DTZ_Final_Entry>;
...
// See dtz_entry_from_storage above for the DRAW-is-companion-authoritative rule.
